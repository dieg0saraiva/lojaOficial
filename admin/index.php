...
<head>
<meta charset="utf-8">
<title>BCM área administrativa</title>
	...
	<h1>PAINEL DE CONTROLE</h1>	
		<div class="lado-esq">
				<ul>
					...
					<li><a href="index.php?link=6">Editora</a> </li>
...
<div class="base-direita">
		<?php 
			...
			$pag[6] = "lst/lst_editora.php" ;
			$pag[7] = "frm/frm_editora.php" ;
			$pag[8] = "lst/lst_produto.php" ;
			$pag[9] = "frm/frm_produto.php" ;
			$pag[10] = "lst/lst_produto.php" ;
			$pag[11] = "frm/frm_produto.php" ;			
